...
class LibraryTest {
    ...
    @Test fun fizzbuzzToTen() {
        assertEquals("FIZZBUZZFIZZDOH!FIZZBUZZ", fizzbuzzExtra(1..10))
    }

    @Test fun fizzbuzzToForty() {
        assertEquals("FIZZBUZZFIZZDOH!FIZZBUZZFIZZDOH!FIZZBUZZFIZZBUZZFIZZFIZZBUZZFIZZDOH!FIZZBUZZFIZZBUZZFIZZFIZZBUZZ", fizzbuzzExtra(1..40))
    }
